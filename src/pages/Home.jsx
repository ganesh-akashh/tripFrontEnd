...
import travelerImageDesktop from '../assets/img/tc_cards_desktop.jpeg'
import travelerImageTablet from "../assets/img/tc_cards_tablet.jpeg"
        ...
        <div className=''>
            ...
            <div className="bg-[#004f32] mt-10 ">
                <div className="container mx-auto mmd:grid mmd:grid-cols-12 h-[400px] sm:h-[500px] mmd:h-[600px] overflow-hidden">
                    ...
                    <div className="hidden mmd:block h-full col-span-9 bg-cover" style={{ backgroundImage: `url(${travelerImageDesktop})`, backgroundRepeat: 'no-repeat' }} />
                    <div className="block mmd:hidden h-full bg-contain bg-top" style={{ backgroundImage: `url(${travelerImageTablet})`, backgroundRepeat: 'no-repeat' }} />
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 py-10">
                ...
                <div>
                    <div className="flex text-sm md:text-base space-x-4 md:space-x-8 ">

                        <h3 className={`${toggle.toGo ? 'border-black' : 'border-transparent'} font-medium mb-3 border-b-2 pb-1 hover:border-black cursor-pointer`}
